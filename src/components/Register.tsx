    ...
    return (
        ...
        <form className="register-form" autoComplete="off" onSubmit={handleSubmit}>
            ...
            <section className="input-section">
                ...
                <input type="email" id="email" placeholder="Enter your email" name="email" value={email} onChange={(event) => setEmail(event.target.value)}/>
            ...
            <section className="input-section">
                ...
                <input type="text" id="username" placeholder="Enter your username" name="username" value={username} onChange={(event) => setUsername(event.target.value)}/>
            ...
            <section className="input-section">
                ...
                <input type="password" id="password" placeholder="Enter your password" name="password" value={password} onChange={(event) => setPassword(event.target.value)}/>
